...
A [Python-based end-to-end (E2E) test automation framework](https://supriya-mainalli.github.io/pytest-automations-e2e) built with **Pytest**, **Selenium WebDriver**, and **Allure** reporting. This for learning and experimentation with API and webautomations. The project follows the **Page Object Model (POM)** design pattern and currently covers web UI automation for the [OrangeHRM demo application](https://opensource-demo.orangehrmlive.com/).
